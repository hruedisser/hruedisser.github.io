...
<div class="row text-center mt-5 justify-content-center">
    <div class="col-md-2">
        <a href="https://www.calameo.com/read/005503280719e28f2a42f" target="_blank">
            <img src="/assets/img/project1/handbook.jpg" alt="FDL 2024 Handbook" class="img-fluid rounded z-depth-1 smaller-img" style="height: 100%; width: auto; object-fit: contain;">
        </a>
        <p>FDL 2024 Handbook</p>
    </div>
    <div class="col-md-5">
        <a href="https://eslab.ai/fdl-europe-2024" target="_blank">
            <img src="/assets/img/project1/Teamcard.jpg" alt="Team Card" class="img-fluid rounded z-depth-1" style="height: 100%; width: auto; object-fit: contain;">
        </a>
        <p>Team Card</p>
    </div>
    <div class="col-md-5">
        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/69KLTd6Mn5Q" frameborder="0" allowfullscreen class="rounded z-depth-1"></iframe>
